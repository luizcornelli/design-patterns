...
public class Client {
	...
	public static FileSystemItem createCompositeFromFile(File file) {
		...
		if (!file.isDirectory()) {
			...
			return new structural.composite.File(file.getName());
		}
	...
	public static void main(String[] args) {
		...
		FileSystemItem file1 = new structural.composite.File("File1.txt");
		FileSystemItem file2 = new structural.composite.File("File2.txt");
		FileSystemItem file3 = new structural.composite.File("File3.txt");
		FileSystemItem file4 = new structural.composite.File("File4.txt");
